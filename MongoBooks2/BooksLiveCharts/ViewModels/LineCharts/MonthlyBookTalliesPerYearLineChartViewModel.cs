...
namespace BooksLiveCharts.ViewModels.LineCharts
{
    ...
    /// </summary>
    public sealed class MonthlyBookTalliesPerYearLineChartViewModel : BaseLineChartViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MonthlyBookTalliesPerYearLineChartViewModel"/> class.
        /// </summary>
        public MonthlyBookTalliesPerYearLineChartViewModel()
        {
            Title = "Monthly Books Read Tallies by Year";
