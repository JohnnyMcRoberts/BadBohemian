...
namespace BooksLiveCharts.ViewModels.LineCharts
{
    ...
    /// The percentage books read by language with time line chart view model class.
    /// </summary>
    public sealed class PercentageBooksReadByLanguageLineChartViewModel : BaseLineChartViewModel
    {
        /// <summary>
        ...
        /// <param name="languageNamesAndValues">The countries nad the associated percentages.</param>
