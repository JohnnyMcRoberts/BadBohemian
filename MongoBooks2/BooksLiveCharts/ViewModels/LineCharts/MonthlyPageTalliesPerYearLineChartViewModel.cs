...
// </copyright>
// <summary>
//   The  monthly page tallies for each calendar year line chart view model.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace BooksLiveCharts.ViewModels.LineCharts
{
    ...
    /// </summary>
    public sealed class MonthlyPageTalliesPerYearLineChartViewModel : BaseLineChartViewModel
    {
        /// <summary>
        ...
        protected override void SetupSeries()
        {
            ...
            foreach (int year in bookListsByMonthOfYear.Keys.ToList().OrderBy(x => x))
            {
                ...
                {
                    // Get the tally for this month if set;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MonthlyPageTalliesPerYearLineChartViewModel"/> class.
        /// </summary>
        public MonthlyPageTalliesPerYearLineChartViewModel()
        {
            Title = "Monthly Pages Read Tallies by Year";
