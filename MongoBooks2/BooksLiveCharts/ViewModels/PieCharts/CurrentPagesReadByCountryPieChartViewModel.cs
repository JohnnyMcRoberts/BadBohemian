// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CurrentPagesReadByCountryPieChartViewModel.cs" company="N/A">
//   2016
// </copyright>
// <summary>
...
namespace BooksLiveCharts.ViewModels.PieCharts
{
    ...
    /// <summary>
    /// The pages by country pie chart view model class.
    /// </summary>
    public sealed class CurrentPagesReadByCountryPieChartViewModel : BasePieChartViewModel
    {
        /// <summary>
        ...
        /// </summary>
        public CurrentPagesReadByCountryPieChartViewModel()
        {
