namespace BooksUtilities.Logging
{
    using System;
    using System.IO;
    using log4net;
    ...
    public class Logger
    {
        ...
        private static readonly ILog _log = Create(Path.GetDirectoryName(System.Diagnostics.Process.GetCurrentProcess().MainModule.FileName));
