...
{
    public class Extras : DependencyObject
    {
        public static readonly DependencyProperty IsSubscribedToSelectionChangedProperty = DependencyProperty.RegisterAttached(
               "IsSubscribedToSelectionChanged", typeof(bool), typeof(Extras), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty SelectedItemsProperty = DependencyProperty.RegisterAttached(
            "SelectedItems", typeof(IList), typeof(Extras), new PropertyMetadata(default(IList), OnSelectedItemsChanged));
