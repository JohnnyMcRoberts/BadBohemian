...
namespace BooksOxyCharts.PlotGenerators
{
    ...
    public class MonthlyPagesAsColumnsTalliesByCalendarYearPlotGenerator : MonthlyBookTalliesByCalendarYearPlotGenerator
    {
        public MonthlyPagesAsColumnsTalliesByCalendarYearPlotGenerator() : base(ChartType.PagesAsColumns) { }
    }

    public class MonthlyBooksAsColumnsTalliesByCalendarYearPlotGenerator : MonthlyBookTalliesByCalendarYearPlotGenerator
    {
        public MonthlyBooksAsColumnsTalliesByCalendarYearPlotGenerator() : base(ChartType.BooksAsColumns) { }
    }
