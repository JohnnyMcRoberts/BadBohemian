// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TalliesPerCalendarYearPlotGenerator.cs" company="N/A">
//   2016
// </copyright>
// <summary>
...
namespace BooksOxyCharts.PlotGenerators
{
    ...
    public class TalliesPerCalendarYearPlotGenerator : BasePlotGenerator
    {
        /// <summary>
        ...
        private Dictionary<int, List<DayOfYearTally>> GetBookListsByDayAndYear()
        {
            ...
            foreach (var book in BooksReadProvider.BooksRead)
            {
